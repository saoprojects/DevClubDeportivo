...
class Evento extends ActiveRecord {
    ...
    protected static $columnasDB = ['id', 'nombre', 'descripcion', 'disponibles', 'categoria_id', 'dia_id', 'hora_id', 'entrenador_id', 'imagen'];
    ...
    public function validar() {
        ...
        if(!$this->entrenador_id || !filter_var($this->entrenador_id, FILTER_VALIDATE_INT) ) {
